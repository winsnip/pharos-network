...
//Reference https://an.io/address/0xC75650fe4D14017b1e12341A97721D5ec51D5340
const poolAbi = [
...
interface TypeArgs {
  poolAddress: string,
  addresses:  Record<"tokenA" | "tokenB", string>
...
export async function getPrice({
  ...
  const address0 = new Contract(token0, ERC20ABI, provider)
  const decimal0 = await Promise.all([address0.decimals()])
  const address1 = new Contract(token1, ERC20ABI, provider)
